...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    ...
    // Oude select element is verwijderd, dus de code is hier aangepast
    ...
    const updateSelectedStreams = () => {
        const selected = Array.from(checkboxes).filter(cb => cb.checked && !['selectAllStreaming', 'selectNoneStreaming'].includes(cb.id)).map(cb => cb.value);
